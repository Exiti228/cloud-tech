...
public class UserController {
    ...
    @PostMapping(value = "/users/movies")
    ...
    public User getUser(@RequestParam @Parameter(required = true, description = "UUID пользователя, которого надо получить", example = "9ba48d0b-843d-4a21-981f-3ec9c163e88d") String id) {
    ...
    public void putUser(@Valid @RequestBody PutUser putUser,
                        @RequestParam @Parameter(required = true, description = "UUID пользователя, которого надо изменить", example = "9ba48d0b-843d-4a21-981f-3ec9c163e88d") String id) {
